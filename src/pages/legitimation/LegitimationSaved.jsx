...
export default function LegitimationSaved() {
  ...
  return (
    <div className="p-6 legitimation-saved-anim-page">
      ...
      <div className="mb-6 space-y-3">
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
          ...
          <span
            className="legitimation-saved-anim-action inline-flex items-center justify-center gap-2 px-4 py-2.5 border-2 border-emerald-600 bg-emerald-50 text-emerald-900 text-sm font-semibold rounded-lg opacity-0 text-center min-h-[2.75rem] cursor-default"
        ...
        <Link
          ...
          className="legitimation-saved-anim-action inline-flex items-center gap-2 px-4 py-2.5 bg-[var(--primary-blue)] text-white text-sm font-medium rounded-lg hover:bg-[var(--primary-blue-light)] transition-all duration-200 ease-out hover:shadow-md hover:scale-[1.02] active:scale-[0.98] opacity-0 w-full sm:w-auto justify-center"
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div className="rounded-lg border border-gray-200 bg-white px-3 py-2 inline-block" aria-label={`Legitimation total: ${legitimationTotal}`}>
          <span className="text-sm font-bold text-gray-600">Total: {legitimationTotal}</span>
        </div>
        {list.length > 0 && (
      ...
      {list.length === 0 ? (
        <div className="legitimation-saved-anim-empty rounded-xl border border-dashed border-gray-300 bg-white p-6 text-sm text-gray-500 text-center">
      ...
      {confirmDeleteId != null && (
        <div className="legitimation-saved-anim-backdrop fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="confirm-remove-title">
