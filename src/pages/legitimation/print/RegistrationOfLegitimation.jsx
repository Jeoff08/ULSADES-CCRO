...
/** REGISTRATION OF LEGITIMATION – legitimation form print. */
export default function RegistrationOfLegitimation({ data }) {
  ...
  return (
    <div className="ausf-doc print-doc bg-white text-black text-sm max-w-[210mm] mx-auto px-6 py-4 leading-normal flex flex-col min-h-[297mm]">
      ...
      <h2 className="text-center font-bold text-xl uppercase mb-6 tracking-tight">REGISTRATION OF LEGITIMATION</h2>

      <p className="font-bold mb-4">TO WHOM IT MAY CONCERN:</p>

      <div className="space-y-6 text-justify leading-[2]">
        <p>
          This certifies the registration of legitimation for the child <span className="font-bold">{childFull || '—'}</span>,
          parents {fatherFull || '—'} and {motherFull || '—'}.
        </p>
        <p>
          Registry No. <span className="font-bold">{data.affidavitLegitRegistryNo || '—'}</span> dated {formatDateCert(data.affidavitLegitDate) || '—'}.
        </p>
        <p>
