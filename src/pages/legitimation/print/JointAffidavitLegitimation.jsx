...
/** JOINT AFFIDAVIT LEGITIMATION – legitimation form print. */
export default function JointAffidavitLegitimation({ data }) {
  ...
  return (
    <div className="ausf-doc print-doc bg-white text-black text-sm max-w-[210mm] mx-auto px-6 py-4 leading-normal flex flex-col min-h-[297mm]">
      ...
      <h2 className="text-center font-bold text-xl uppercase mb-6 tracking-tight">JOINT AFFIDAVIT LEGITIMATION</h2>

      <p className="font-bold mb-4">TO WHOM IT MAY CONCERN:</p>

      <div className="space-y-6 text-justify leading-[2]">
        <p>
          This is the Joint Affidavit Legitimation form for the child <span className="font-bold">{childFull || '—'}</span>,
