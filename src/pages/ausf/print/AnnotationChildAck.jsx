...
/**
 * Annotation (Child Ack): attach a scan copy of the COLB office file and edit
 * the annotation. The "white" REMARKS/ANNOTATION area changes to show the
 * annotation when the child is acknowledged.
 */
export default function AnnotationChildAck({ data, onColbScanChange, onAnnotationChange }) {
  ...
  return (
    <div className={`ausf-doc print-doc colb-annotation-ack bg-white text-black text-sm max-w-[210mm] mx-auto flex flex-col relative ${hasScan ? 'px-4 py-3 print:px-0 print:py-0 print:max-w-none' : 'px-4 py-3'}`}>
              ...
              <>
                ...
                <div
                  ...
                  style={{
                    ...
                    minWidth: '2.5rem',
                    padding: '1.75rem',
                    backgroundColor: 'rgba(212, 212, 212, 0.95)',
                  }}
                >
                  <p
      ...
      {!hasScan && (
        <div className="print:hidden">
          ...
          <div className="border border-black min-h-[5rem] p-4 bg-white">
            <p className="text-sm whitespace-pre-wrap">{renderAnnotationContent()}</p>
          </div>
        </div>
      )}
      ...
      {showUploadModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50" role="dialog" aria-modal="true" aria-labelledby="upload-modal-title">
