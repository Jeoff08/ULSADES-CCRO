...
export default function AUSFSaved() {
  ...
  const handleEdit = (id) => {
    if (loadSavedAUSFToDraft(id)) navigate(`/ausf?edit=1&id=${encodeURIComponent(id)}`)
  }
  ...
  const handleConfirmDelete = () => {
    ...
    if (item) setLastDeletedItem({ ...item, data: { ...item.data } })
            ...
            <div className="relative bg-gradient-to-b from-red-50/80 to-white px-6 pt-6 pb-5">
              ...
              <div className="flex gap-4">
                ...
                <div className="min-w-0 flex-1 pt-0.5">
                  ...
                  <p className="mt-1.5 text-sm text-gray-600 leading-relaxed">This saved AUSF file will be permanently removed. You can use Undo in the toast after removing if you change your mind.</p>
                </div>
              </div>
            </div>
