...
/** ANNOTATION FOR FORM 3A – court decree. Layout matches Certificate of Authenticity. */
export default function AnnotationForForm3A({ data }) {
  ...
  return (
    <div className="ausf-doc print-doc print-doc-cert-auth bg-white text-black text-sm max-w-[210mm] mx-auto px-6 py-4 leading-normal flex flex-col min-h-[297mm]">
      ...
      <h2 className="text-center font-bold text-xl uppercase mb-6 tracking-tight">ANNOTATION FOR FORM 3A</h2>
