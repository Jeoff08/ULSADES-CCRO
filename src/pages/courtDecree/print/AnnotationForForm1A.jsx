...
/** ANNOTATION FOR FORM 1A – court decree. Print layout matches Certificate of Authenticity. */
export default function AnnotationForForm1A({ data }) {
  ...
  return (
    <div className="ausf-doc print-doc print-doc-cert-auth bg-white text-black text-base max-w-[210mm] mx-auto px-6 py-4 leading-relaxed flex flex-col min-h-[297mm]">
      ...
      <div className="print-doc-body flex flex-col flex-1 min-h-0">
        <h2 className="text-center font-bold text-[30px] uppercase mb-6 tracking-tight">ANNOTATION FOR FORM 1A</h2>
        ...
        <div className="cert-auth-body cert-auth-body-gaps text-justify text-[18px] leading-[1.8] pl-4 print:pl-6">
          <p>
            This document is issued in relation to the court decree. Please follow the standard annotation instructions for LCR Form 1A.
          </p>
          <p>
