...
import { formatDateCert, computeAgeFullYears, lcroStaffTitleForPrint, parseDdMmYyyyToDate } from '../../../lib/printUtils'
      ...
      <div className="court-decree-lcr-footer mt-auto shrink-0 flex flex-col">
        <div className="court-decree-lcr-body mb-1">
          <div className="mb-1 flex flex-col-reverse items-stretch gap-0 court-decree-lcr-3a-signatures">
            <div className="court-decree-lcr-3a-verified-left flex flex-col items-center text-center self-start gap-0">
